...
def main():
    ...
    for filepath in list_imgs(SAVE_DATA_DIR_PATH + "img0"):
        img = img_to_array(load_img(filepath, target_size=(img_width,img_height, img_ch))) #ここで画像サイズ変更
        data_x.append(img)
...
"""
    ...
    # 学習用データとテストデータに分割　test_size=学習用データの20%をテスト用に
